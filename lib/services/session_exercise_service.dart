...
class SessionExerciseService {
  ...
  Future<int> addSessionExercise(SessionExerciseDomain sessionExercise) async {
    return await _sessionExercisePersistance
  ...
  Future<List<SessionExerciseDomain>> getSessionExercisesBySessionId(
      int sessionId) async {
    return await _sessionExercisePersistance
  ...
  Future<int> updateSessionExercise(
      SessionExerciseDomain sessionExercise) async {
    return await _sessionExercisePersistance
